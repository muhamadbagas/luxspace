    ...
    <section className="container mx-auto">
      <div className="flex flex-wrap my-4 md:my-12">
        <div className="w-full md:hidden px-4">
          <div className="w-80 h-16 bg-gray-300 animate-pulse rounded-ful"></div>
          <div className="w-40 h-4 mt-3 bg-gray-300 animate-pulse rounded-ful"></div>
        </div>
        ...
        <div className="flex-1 px-4 md:p-6">
          <div className="w-80 h-16 bg-gray-300 animate-pulse rounded-ful"></div>
          <div className="w-40 h-4 mt-4 bg-gray-300 animate-pulse rounded-ful"></div>

          <div className="w-44 h-10 mt-8 bg-gray-300 animate-pulse rounded-ful"></div>
          <hr className="my-8" />

          <div className="w-36 h-4 mt-6 bg-gray-300 animate-pulse rounded-ful"></div>
          <div className="w-88 h-4 mt-6 bg-gray-300 animate-pulse rounded-ful"></div>
          <div className="w-40 h-4 mt-6 bg-gray-300 animate-pulse rounded-ful"></div>
          <div className="w-96 h-4 mt-6 bg-gray-300 animate-pulse rounded-ful"></div>
          <div className="w-64 h-4 mt-6 bg-gray-300 animate-pulse rounded-ful"></div>
          <div className="w-88 h-4 mt-6 bg-gray-300 animate-pulse rounded-ful"></div>
        </div>
      </div>
    </section>
              ...
              return (
                ...
                >
                  <div className="rounded-xl p-4 pb-8 relative bg-white">
                    ...
                    <div className="w-56 h-4 mt-6 bg-gray-300 animate-pulse rounded-ful"></div>
                    <div className="w-40 h-4 mt-3 bg-gray-300 animate-pulse rounded-ful"></div>
                  </div>
                </div>
              );
      ...
      {isError ? (
        ...
        <>
          ...
          {isLoading ? (
            ...
            <Suggestions data={data?.relatedProducts || {}}></Suggestions>
          )}
        </>
      )}
